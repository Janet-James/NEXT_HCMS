...
(function($) {
    ...
    var getEventHtml = function(event) {
        var eventHtml = $('<a onclick="calendarEvent(' + event.getid + ')" class="event ' + event.class + '"  id="' + event.getid + '"  href="' + event.url + '" ' + (event.color != '' ? 'style="border-color: ' + event.color + ';"' : '') + '></a>');
        eventHtml.data('event-id', event.id);
        eventHtml.append('<b><span class="key1">' + event.key1 +'</b></span>');
        eventHtml.append('<b><span class="key2">' + event.key2 + '</b></span>');
        eventHtml.append('<b><span class="key3">' + event.key3 + '</b></span>');
        return eventHtml;
