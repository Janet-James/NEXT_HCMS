...
(function (root, factory) {
  ...
  */
  ...
  function _placeTooltip(targetElement, tooltipLayer, arrowLayer, helperNumberLayer, hintMode) {
    ...
    tooltipLayer.className = ('animated zoomIn introjs-tooltip ' + tooltipCssClass).replace(/^\s+|\s+$/g, '');
  ...
  function _showElement(targetElement) {
    ...
    if (oldHelperLayer != null) {
      ...
      progressBar.className = 'introjs-progressbar progress-bar-info';
      ...
      if (this._options.showStepNumbers == true) {
        ...
        helperNumberLayer.className = 'introjs-helperNumberLayer btn-info';
      ...
      skipTooltipButton.className = 'btn btn-danger introjs-skipbutton';
    ...
    if (this._currentStep == 0 && this._introItems.length > 1) {
      ...
      if (this._options.hidePrev == true) {
        prevTooltipButton.className = 'btn btn-success introjs-prevbutton introjs-hidden';
        nextTooltipButton.className += ' introjs-fullbutton';
      } else {
        prevTooltipButton.className = 'btn btn-primary introjs-prevbutton introjs-disabled';
      }
      ...
      prevTooltipButton.className = 'btn btn-primary introjs-prevbutton';

      if (this._options.hideNext == true) {
        nextTooltipButton.className = 'btn btn-success introjs-nextbutton introjs-hidden';
        prevTooltipButton.className += ' introjs-fullbutton';
      } else {
        nextTooltipButton.className = 'btn btn-success introjs-nextbutton introjs-disabled';
      }
      ...
      skipTooltipButton.className = 'btn btn-danger introjs-skipbutton';
      prevTooltipButton.className = 'btn btn-info introjs-prevbutton';
      nextTooltipButton.className = 'btn btn-success introjs-nextbutton';
      skipTooltipButton.innerHTML = this._options.skipLabel;
    }
