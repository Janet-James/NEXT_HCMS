...
getOrgChart.prototype.draw = function(a) {
	...
	if (this.config.enableSearch) {
		this._X._zm.style.display = "none";
		this._X._aD.style.display = "none";
		this._X._za.style.display = "none"
	}
