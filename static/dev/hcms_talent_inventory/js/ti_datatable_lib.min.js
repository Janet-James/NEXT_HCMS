...
function empty_datatable(tbl_name,hidden_col){
	var table = $("#"+tbl_name);
...
//Basic Datatable Load function
function basic_datatable(tbl_name){
	var table = $("#"+tbl_name);
	var oTable = table.DataTable({
		lengthMenu: [[5, 10, 15, 20, -1], [5, 10, 15, 20, "All"]],
		pageLength: 5,
...
function editable_datatable1(tbl_name, data_list, tbl_plus_id, titles) {
	// Editable Table load
	var table = $("#"+tbl_name);
	var oTable = table.dataTable({
...
function plaindatatable_btn1(tbl_name, data_list, tbl_columns, hidden_col) {
	...
	doc['header']=(function() {
		return {
			...
			},
			{
				alignment: 'center',
				fontSize: 16,
				text: 'NTE_'+now_date+'_TalentDefinition',
				margin: [0, 15, 20, 0]
			}
			],
		}
